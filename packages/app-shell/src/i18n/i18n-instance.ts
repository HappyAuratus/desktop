...
export const translationResources = {
  "zh-CN": {
    ...
    "errors.spec_document_not_found": "该 Spec 文档已不存在或不再属于自动发现目录。",
    ...
    "chat.historyNotice.unreadableRecords": "有 {{count}} 条历史记录无法读取，缺失位置未知。",
  ...
  "en-US": {
    ...
    "errors.workflow_name_conflict": "A workflow with this name already exists.",
    ...
    "errors.spec_document_not_found": "The Spec document no longer exists or is outside the automatically detected sources.",
    ...
    "dialog.optionsLoading": "Options are still loading. Try again in a moment.",
    ...
    "chat.historyNotice.unreadableRecords": "{{count}} history records could not be read; their positions are unknown.",
    "chat.historyNotice.unrecordedContent": "Part of the conversation was not recorded: {{reason}}",
