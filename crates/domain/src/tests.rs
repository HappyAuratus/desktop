use crate::{
    Artifact, ArtifactId, DomainModelError, Project, ProjectId, Session, SessionId, SessionStatus,
    Task, TaskId, TaskStatus, VirtualEntry, VirtualEntryId, VirtualEntryKind, VirtualFolder,
...
fn constructs_schema_backed_entities() {
    let project = Project::new(ProjectId::new("project-1"), "Ora", "/workspace/ora");
